...
const Layout = ({ children }) => {
    return (
        <div className="min-h-screen bg-pastel-bg flex flex-col font-sans text-pastel-text bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
            ...
            <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8 mb-20 md:mb-8">
            ...
            <footer className="glass-panel mt-auto hidden md:block rounded-t-2xl mx-4 mb-4 border-t-0">
